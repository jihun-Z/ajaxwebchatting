			...
			<ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li class="active"><a href="${path }/home.do">회원가입</a></li>
						</ul>
					</li>
			</ul>
		</div>
			...
			<table class="table table-boardered table-hover" style="textalign:center; border:1px solid #dddddd">
				...
				<tbody>
					<tr>
						...
						<td style="width:100px;"><button class="btn btn-primary" onclick="registerCheckfunction();" type="button" >중복체크</button>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="2"><input onkeyup="passwordCheckFunction();" class="form-control" type="password" id="userPassword1" name="userPassword1" maxlength="20" placeholder="비밀번호 확인 를 입력하세요"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="2"><input  class="form-control" type="text" id="userAge" name="userAge" maxlength="20" placeholder="나이을 입력하세요"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="2"><input  class="form-control" type="email" id="email" name="email" maxlength="20" placeholder="이메일을 입력하세요"/></td>
					</tr>
					<tr>
